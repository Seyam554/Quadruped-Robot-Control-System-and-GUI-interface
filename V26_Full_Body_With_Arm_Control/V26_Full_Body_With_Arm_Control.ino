/*
  ESP32-S3 DevKitC-1 v1.1 Quadruped + Direct-Servo Arm + Claw Controller (PCA9685 + UDP) + IMU Stabilization Overlay
  --------------------------------------------------------------------------------------------------------------------
  Adapted from XIAO ESP32-C6 version.
  Changes:
    - WiFiMulti for multiple SSID/password support with auto-reconnect
    - I2C pins changed to ESP32-S3 DevKitC-1 defaults (GPIO8 SDA, GPIO9 SCL)
...
// ===============================
// 2) I2C BUS (ESP32-S3 DevKitC-1 v1.1)
// ===============================
// Default I2C pins on ESP32-S3 DevKitC-1.
...
void setup() {
  ...
  Serial.println("\n\n=== SYSTEM INITIALIZING (ESP32-S3 DevKitC-1 v1.1) ===");
